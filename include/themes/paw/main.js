...
function themeReady() {
	...
	//login page
	$('.cactiLoginLogo').html("<i class='fa fa-empire'/>").css('font-size: 20px');
	...
	$('.maintabs nav ul li a').each( function() {
		...
		if ( id == 'maintab-anchor-console') {
			$(this).html("<i class='fa fa-empire' style='font-size:35px;color:springgreen'/>").css({'border-right':'1px solid #aaa'});
